            ...
            <div className="projects-container">
                ...
                <div className='card'>
                    ...
                    <div className="container-btn">
                        <Link to="https://alexdesign-portfolio.vercel.app/" target='_blank' id='alex-btn'>Acessar projeto</Link>
                        <Link to="https://github.com/FelCastilho/alexdesign-portfolio" target='_blank' className='repositorio-btn'>Acessar repositório</Link>
                    </div>
